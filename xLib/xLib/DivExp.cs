...
namespace xLib
{
    ...
    {
        public DivExp(Expression e1, Expression e2) : base(e1, e2)
        {
            this.exp1 = e1;
            this.exp2 = e2;
        }
        ...
        {
            return new DivExp(new AddExp(new MulExp(exp1.Derive(), exp2), new MulExp(exp2.Derive(), exp1)), new MulExp(exp2, exp2));
        }
